...
Go to [https://lybra.maps.arcgis.com](https://lybra.maps.arcgis.com) or [https://surinameonline.maps.arcgis.com](https://surinameonline.maps.arcgis.com) (follow instructions from the trainer and assistents), click ‘**Sign In**’ and fill in your username and password. 
...
- **Access online maps and data** — With ArcGIS Online, you can access the ArcGIS Living Atlas of the World, (https://livingatlas.arcgis.com/en/home/ ) a global collection of curated maps and data on thousands of topics. You can use basemaps, imagery, live feeds, and data-driven maps from the Living Atlas to explore information about people, infrastructure, the environment, and more. Once you’ve discovered useful content in the Living Atlas, you can combine it with your own data and use it in your maps and analytics.  
